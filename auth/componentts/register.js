...
class Register {
  ...
  constructor() {
    ...
    this.$linkToSignIn = document.createElement("p");
    this.$linkToSignIn.innerHTML = "You haven an account?";
    this.$linkToSignIn.classList.add("btn_link");
    this.$linkToSignIn.addEventListener("click", this.movetosignin);
  }
  movetosignin = () => {
  ...
  render() {
    ...
    this.$container.appendChild(this.$linkToSignIn)
